...
export const getAiConfigs = () => request.get('/admin/ai/config')
export const createAiConfig = (data) => request.post('/admin/ai/config', data)
export const updateAiConfig = (id, data) => request.put(`/admin/ai/config/${id}`, data)
export const deleteAiConfig = (id) => request.delete(`/admin/ai/config/${id}`)
export const testAiConnection = (data) => request.post('/admin/ai/config/test', data)
export const getAiUsers = (params) => request.get('/admin/ai/users', { params })
export const generateAiUsers = (groupId, configId, count) => request.post(`/admin/ai/generate/${groupId}`, { config_id: configId, count })
export const regenerateAiUsers = (groupId, configId, count) => request.post(`/admin/ai/regenerate/${groupId}`, { config_id: configId, count })
export const triggerAiTrade = () => request.post('/admin/ai/trigger', null, { timeout: 120000 })
export const getAiLogs = (params) => request.get('/admin/ai/logs', { params })
export const updateAiUserNickname = (id, nickname) => request.put(`/admin/ai/users/${id}`, { nickname })
export const updateAiUserPrompt = (id, personality_prompt) => request.put(`/admin/ai/users/${id}`, { personality_prompt })
export const setAiUserStatus = (id, status) => request.put(`/admin/ai/users/${id}`, { status })

export const getAnnouncementAdmin = () => request.get('/admin/announcement')
export const saveAnnouncement = (data) => request.put('/admin/announcement', data)
export const translateAnnouncement = (data) => request.post('/admin/announcement/translate', data)