...
export const generateAiUsers = (groupId, configId) => request.post(`/admin/ai/generate/${groupId}`, { config_id: configId })
export const regenerateAiUsers = (groupId, configId) => request.post(`/admin/ai/regenerate/${groupId}`, { config_id: configId })
